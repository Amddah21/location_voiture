...
// Note: Prices in database are stored in MAD (Moroccan Dirham)
function convertPrice(price, targetCurrency) {
    // Prices are always stored in MAD in the database
    if (targetCurrency === 'EUR') {
        // Convert from MAD to EUR (divide by exchange rate)
...
window.updateAllPricesOnPage = updateAllPricesOnPage;
